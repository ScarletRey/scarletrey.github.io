...
/***/ (function(module, exports, __webpack_require__) {
	...
	// Вроди как фиксит ползунок при пусток кэше
	(0, _jquery2.default)(window).load(function () {
	    (0, _jquery2.default)(window).trigger("resize.twentytwenty");
	});
	...
	(0, _jquery2.default)('.item-img input').prop("checked", false);
	(0, _jquery2.default)('.item-img input').click(function () {
	    if ((0, _jquery2.default)('.item-img input').prop("checked")) {
...
//# sourceMappingURL=0.c90ea2363590dbd6762f.hot-update.js.map