...
/***/ (function(module, exports, __webpack_require__) {
	...
	(0, _jquery2.default)('.item-img input').prop("checked").parent().addClass('active');
	
	// $('.item-img input').click(function() {
	//   if ($('.item-img input').prop( "checked" )) {
...
//# sourceMappingURL=0.63c2d851b6ff85729765.hot-update.js.map