...
/******/ 	var hotCurrentHash = "64a617abdfe63c6ad4dc"; // eslint-disable-line no-unused-vars
...
/***/ (function(module, exports, __webpack_require__) {
	...
	(0, _jquery2.default)('.slide-down a').on('click', function (e) {
		e.preventDefault();
	...
	//  Бургер батон
	(0, _jquery2.default)('.hamburger-btn').click(function () {
		(0, _jquery2.default)(this).toggleClass('is-active');
		(0, _jquery2.default)(this).parent().toggleClass('is-active');
	});
	...
	var rangeSlider = function rangeSlider() {
		var slider = (0, _jquery2.default)('.filter-price__range'),
		    range = (0, _jquery2.default)('.filter-price__range .input-range'),
		    value = (0, _jquery2.default)('.filter-price__range-value .num');
	
		slider.each(function () {
	
			value.each(function () {
				var value = (0, _jquery2.default)(this).parent().prev().attr('value');
				(0, _jquery2.default)(this).text(value);
			});
	
			range.on('input', function () {
				(0, _jquery2.default)(this).next().children('.num').text(this.value);
			});
		});
	};
	...
	(0, _jquery2.default)('.filter-dropdown__title, .filter-price__title').click(function () {
		(0, _jquery2.default)(this).toggleClass('is-active');
		(0, _jquery2.default)(this).next().slideToggle('fast');
	});
	
	(0, _jquery2.default)('.card__filter-btn').click(function () {
		(0, _jquery2.default)('.left-filter').toggleClass('is-active');
	});
	
	// Filter end
	
	(0, _jquery2.default)('.card-tabs .btn').click(function () {
		var btnNum = (0, _jquery2.default)(this).index();
		(0, _jquery2.default)('.card-tabs .btn').removeClass('is-active');
		(0, _jquery2.default)(this).addClass('is-active');
		(0, _jquery2.default)('.card-tabs .tab').removeClass('is-active');
		(0, _jquery2.default)('.card-tabs .tab:eq(' + btnNum + ')').addClass('is-active');
	});
	
	//  Карусели начало
	
	(0, _jquery2.default)('.top-slider').owlCarousel({
		animateOut: 'fadeOut',
		animateIn: 'fadeIn',
		mouseDrag: false,
		touchDrag: false,
	...
	(0, _jquery2.default)('.hit-slider').owlCarousel({
		mouseDrag: true,
		touchDrag: true,
		margin: 5,
		loop: true,
	...
	(0, _jquery2.default)('.home__collection').owlCarousel({
		mouseDrag: true,
		touchDrag: true,
		margin: 0,
		loop: false,
	...
	(0, _jquery2.default)('.home__collection').prepend((0, _jquery2.default)('.home__collection .owl-dots')); // Переместил точки наверх
	
	(0, _jquery2.default)('.home__review').owlCarousel({
		mouseDrag: true,
		touchDrag: true,
		margin: 0,
		loop: true,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _getOwnPropertyNames = __webpack_require__(6);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__webpack_require__(9)('getOwnPropertyNames', function () {
	  return __webpack_require__(25).f;
	});
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var gOPNExt = __webpack_require__(25);
